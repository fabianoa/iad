...
Pretendemos utilizar técnicas de Mineração de Texto (Text Mining)  com suas fase de pré processamento: tokenização, conversão para minúsculo, exclusão de pontuação, exclusão de números e de palavras de paradas (stop words).
