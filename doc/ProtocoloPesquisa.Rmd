...
Um fato importante a respeito dos dados dos discursos é que os mesmos na verdade são uma transcrição do que foi falado em plenário. Nesta transcrição algumas informações textuais foram inseridas  que representam situações ocorridas na sessão. Por exemplo, em alguns discursos existem  referências a palmas como (.Palmas). Em outros existem inserções de pequenos trechos de fala do presidente da sessão, agradecendo pelo discurso. Algumas destas  ocorrências podem ser removidas facilmente, mas  outras não poderão e serão consideradas como parte do discurso.
...
Porém, quando tentamos integrar os dados das duas fontes (Câmara de Deputados e Dados eleitorais) com objetivo de consolidar os dados demográficos dos deputados com os discursos, notamos  que os únicos atributos que poderíamos utilizar para relacionar uma fonte com outras seria o nome completo do deputado ou o nome político do mesmo.
